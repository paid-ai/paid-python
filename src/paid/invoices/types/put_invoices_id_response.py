...
class PutInvoicesIdResponse(UniversalBaseModel):
    id: str
    ...
    status: PutInvoicesIdResponseStatus
    payment_status: typing_extensions.Annotated[
        PutInvoicesIdResponsePaymentStatus, FieldMetadata(alias="paymentStatus")
    ]
    source: PutInvoicesIdResponseSource
    ...
    tax_status: typing_extensions.Annotated[PutInvoicesIdResponseTaxStatus, FieldMetadata(alias="taxStatus")]
