...
class GetInvoicesResponseDataItem(UniversalBaseModel):
    id: str
    ...
    status: GetInvoicesResponseDataItemStatus
    payment_status: typing_extensions.Annotated[
        GetInvoicesResponseDataItemPaymentStatus, FieldMetadata(alias="paymentStatus")
    ]
    source: GetInvoicesResponseDataItemSource
    ...
    tax_status: typing_extensions.Annotated[GetInvoicesResponseDataItemTaxStatus, FieldMetadata(alias="taxStatus")]
