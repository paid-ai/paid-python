...
class GetInvoicesIdResponse(UniversalBaseModel):
    id: str
    ...
    status: GetInvoicesIdResponseStatus
    payment_status: typing_extensions.Annotated[
        GetInvoicesIdResponsePaymentStatus, FieldMetadata(alias="paymentStatus")
    ]
    source: GetInvoicesIdResponseSource
    ...
    tax_status: typing_extensions.Annotated[GetInvoicesIdResponseTaxStatus, FieldMetadata(alias="taxStatus")]
