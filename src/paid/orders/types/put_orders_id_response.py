...
class PutOrdersIdResponse(UniversalBaseModel):
    id: str
    ...
    creation_state: typing_extensions.Annotated[PutOrdersIdResponseCreationState, FieldMetadata(alias="creationState")]
