...
class GetOrdersIdResponse(UniversalBaseModel):
    id: str
    ...
    creation_state: typing_extensions.Annotated[GetOrdersIdResponseCreationState, FieldMetadata(alias="creationState")]
