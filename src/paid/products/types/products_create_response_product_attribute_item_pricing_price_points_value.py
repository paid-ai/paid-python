...
class ProductsCreateResponseProductAttributeItemPricingPricePointsValue(UniversalBaseModel):
    ...
    tiers: typing.Optional[typing.List[ProductsCreateResponseProductAttributeItemPricingPricePointsValueTiersItem]] = (
        None
    )
