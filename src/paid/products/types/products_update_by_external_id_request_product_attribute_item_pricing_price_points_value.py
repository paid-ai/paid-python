...
class ProductsUpdateByExternalIdRequestProductAttributeItemPricingPricePointsValue(UniversalBaseModel):
    ...
    tiers: typing.Optional[
        typing.List[ProductsUpdateByExternalIdRequestProductAttributeItemPricingPricePointsValueTiersItem]
    ] = None
