...
class ProductsListResponseItemProductAttributeItemPricingPricePointsValue(UniversalBaseModel):
    ...
    tiers: typing.Optional[
        typing.List[ProductsListResponseItemProductAttributeItemPricingPricePointsValueTiersItem]
    ] = None
