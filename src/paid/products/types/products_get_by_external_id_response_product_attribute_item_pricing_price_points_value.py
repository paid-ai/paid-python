...
class ProductsGetByExternalIdResponseProductAttributeItemPricingPricePointsValue(UniversalBaseModel):
    ...
    tiers: typing.Optional[
        typing.List[ProductsGetByExternalIdResponseProductAttributeItemPricingPricePointsValueTiersItem]
    ] = None
