...
class ProductsGetResponseProductAttributeItemPricingPricePointsValue(UniversalBaseModel):
    ...
    tiers: typing.Optional[typing.List[ProductsGetResponseProductAttributeItemPricingPricePointsValueTiersItem]] = None
