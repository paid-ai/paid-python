...
class ProductsUpdateRequestProductAttributeItemPricingPricePointsValue(UniversalBaseModel):
    ...
    tiers: typing.Optional[typing.List[ProductsUpdateRequestProductAttributeItemPricingPricePointsValueTiersItem]] = (
        None
    )
