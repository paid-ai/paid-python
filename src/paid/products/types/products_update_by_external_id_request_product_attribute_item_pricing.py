...
class ProductsUpdateByExternalIdRequestProductAttributeItemPricing(UniversalBaseModel):
    ...
    charge_type: typing_extensions.Annotated[
        ProductsUpdateByExternalIdRequestProductAttributeItemPricingChargeType, FieldMetadata(alias="chargeType")
    ]
    pricing_model: typing_extensions.Annotated[
        ProductsUpdateByExternalIdRequestProductAttributeItemPricingPricingModel, FieldMetadata(alias="pricingModel")
    ]
    ...
    price_points: typing_extensions.Annotated[
        typing.Dict[str, ProductsUpdateByExternalIdRequestProductAttributeItemPricingPricePointsValue],
