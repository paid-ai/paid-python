...
class GetCustomersResponseDataItem(UniversalBaseModel):
    id: str
    name: str
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[GetCustomersResponseDataItemBillingAddress], FieldMetadata(alias="billingAddress")
    ] = None
    creation_state: typing_extensions.Annotated[
        GetCustomersResponseDataItemCreationState, FieldMetadata(alias="creationState")
    ]
