...
class PutCustomersExternalExternalIdResponse(UniversalBaseModel):
    id: str
    name: str
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[PutCustomersExternalExternalIdResponseBillingAddress], FieldMetadata(alias="billingAddress")
    ] = None
    creation_state: typing_extensions.Annotated[
        PutCustomersExternalExternalIdResponseCreationState, FieldMetadata(alias="creationState")
    ]
