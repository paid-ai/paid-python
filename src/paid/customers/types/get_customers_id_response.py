...
class GetCustomersIdResponse(UniversalBaseModel):
    id: str
    name: str
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[GetCustomersIdResponseBillingAddress], FieldMetadata(alias="billingAddress")
    ] = None
    creation_state: typing_extensions.Annotated[
        GetCustomersIdResponseCreationState, FieldMetadata(alias="creationState")
    ]
