...
class PostCustomersResponse(UniversalBaseModel):
    id: str
    name: str
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[PostCustomersResponseBillingAddress], FieldMetadata(alias="billingAddress")
    ] = None
    creation_state: typing_extensions.Annotated[
        PostCustomersResponseCreationState, FieldMetadata(alias="creationState")
    ]
