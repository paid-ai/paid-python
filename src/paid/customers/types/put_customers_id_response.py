...
class PutCustomersIdResponse(UniversalBaseModel):
    id: str
    name: str
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[PutCustomersIdResponseBillingAddress], FieldMetadata(alias="billingAddress")
    ] = None
    creation_state: typing_extensions.Annotated[
        PutCustomersIdResponseCreationState, FieldMetadata(alias="creationState")
    ]
