...
from agents import Agent, Runner, TContext, TResponseInputItem, RunResult
...
class PaidRunner:
    ...
    def run_sync(self, starting_agent: Agent[TContext], input: str | list[TResponseInputItem], **kwargs) -> RunResult:
