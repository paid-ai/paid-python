...
class GetContactsExternalExternalIdResponse(UniversalBaseModel):
    id: str
    ...
    billing_address: typing_extensions.Annotated[
        typing.Optional[GetContactsExternalExternalIdResponseBillingAddress], FieldMetadata(alias="billingAddress")
    ] = None
