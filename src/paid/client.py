...
from .tracing import _initialize_tracing, _trace, _signal
...
class Paid:
    ...
    def trace(
        ...
        fn : typing.Callable[[], typing.Union[T, typing.Awaitable[T]]]
            The function or coroutine to be traced. Should be a callable that returns either a value or an awaitable.
    ...
    def signal(self, event_name: str, data: typing.Optional[typing.Dict] = None):
        ...
        data : typing.Optional[typing.Dict], optional
            Additional data to include with the signal event (ex. cost tracking data).
